...
| 5   | **The mingling assembles the tale.** Every player holds a fragment of what already happened; encounters are how the room pieces it together, and the evening ends with the story reconstructed and someone named.                                                                                                                                                                                                                                                                                                                                                                   | **Enacting the tale** — encounters change real state, the curse spreads by contact, someone actually falls asleep until woken; **a chase** — private goals and transactional encounters, the tale as setting for a race.                                    | Chosen as the version with teeth for the adults, and it is the only one of the three that reliably produces the argument afterwards that this repo treats as the test of whether a game worked. The cost is precise and lands on exactly the wrong person: assembling a story means holding fragments, reading them and reasoning across them, and a five-year-old can do none of the three. Enacting was the option she could have played without reading a word — she would only have to notice she had been cursed. Choosing assembly makes "how does the five-year-old play" a design problem that must now be solved deliberately, where enacting would have solved it for free.                                                                                     |
| 6   | **Two games in one room, coupled by pretend.** In Topher's words: _"the children will have the most fun playing pretend and having adults play pretend with them. the adults have fun putting together the puzzle."_ The child's game is being a princess and recruiting grown-ups into the story. The adults' game is assembling the tale. The coupling is that fragments are held by the children and the price of one is entering the story with them — curtsy, call her Your Majesty, be her knight for a minute — so the adults' puzzle can only be solved by playing pretend. | **All four framings offered**: the only witness everyone must visit; the truth-teller whose questions must be answered honestly; the courier who carries fragments while the parent thinks; a player at full parity whose fragments are illustrated.        | Every one of the four made the child a piece inside the adults' deduction game, and differed only in which piece. That is the wrong axis. The child's fun is not a function in the puzzle — it is pretending, and getting adults to pretend back — so any design that hands her a puzzle role makes her the smallest player in a game she cannot follow, however generous the role is. Reframing to two coupled games solves decision 5's cost outright rather than mitigating it: the adults keep their teeth, the children never touch a deduction, and the two are bound because the grown-ups cannot win without kneeling to a five-year-old first.                                                                                                                   |
| 7   | **Every encounter is reported and confirmed, and pieces arrive unattributed.** You say you met someone; they (or, for a child, their grown-up) confirm it; both sides are then dealt a piece of the puzzle. You are never told who a piece came from.                                                                                                                                                                                                                                                                                                                               | **Each player holding one fixed clue** for the whole evening, which is what the first build did.                                                                                                                                                            | Topher's own reframing, and it creates the asymmetry the rest of the design hangs on: the _encounter_ is public, the _piece_ is private. That is what makes a liar both possible and catchable — you cannot tell who handed you a bad piece, but you can tell who you met, so the room convicts by intersecting encounter lists out loud. A fixed clue per player has no such structure: the only thing to do with it is say it.                                                                                                                                                                                                                                                                                                                                          |
| 8   | **Only the curser may hand over something untrue**, two or three times a night depending on party size. Every other phone is physically incapable of emitting a falsehood.                                                                                                                                                                                                                                                                                                                                                                                                          | **The curse spreading by touch** — the culprit's encounter infects you, and a cursed player's pieces come out garbled.                                                                                                                                      | The spreading curse is far more legible to a five-year-old, and was rejected anyway because it announces the culprit's position: the room triangulates the infection front in ten minutes. Restricting lies to one player means every contradiction in the hall is that player's fingerprint, with nobody needing to be trusted for it to hold. Measured across 2000 parties: the room never silently converges on an innocent — 1971 of them surface a visible contradiction instead, which is the tell. It also scales the right way, since more guests means more encounters and a tighter intersection.                                                                                                                                                               |
| 9   | **Timed rounds with a nomination and a weighted vote, and banishment does not remove you.** A banished guest keeps mingling, keeps collecting pieces and keeps arguing; they simply have one voice left to spend and cannot be put up again. Vote weight is one, plus one per grown-up who has knelt to a child of yours, capped at three.                                                                                                                                                                                                                                          | **Elimination on a lost vote**, the ordinary Werewolf ending.                                                                                                                                                                                               | Straight from Blood on the Clocktower, and the reason to take it is that the failure mode of every Mafia clone is a room half full of people who have nothing to do and cannot speak. At twenty guests that is ten bored people. Making banishment a spent voice rather than an exit keeps every guest inside the evening. The weighting is where the two games of decision 6 finally become one: a five-year-old who has charmed five grown-ups hands her partner four voices, so the pretend game decides the argument.                                                                                                                                                                                                                                                 |
| 10  | **The candles are the curser's clock.** Five burn over the night: one at the end of every round, and a second whenever the hall banishes an innocent. Banish the curser and the curse breaks; let the last candle go out and Aurora sleeps and the curser has won. A curser who brought a child wins with them, per decision 2.                                                                                                                                                                                                                                                     | **A plain round cap** — survive N rounds and the curser wins; **an errand for the curser** — a secret objective to complete during the night.                                                                                                               | The tale's own prompt already said _find out who before the last candle goes out_, so the clock was written before the mechanic was. Taking it literally does three things a round cap does not: it prices a wrongful banishment, so the vote has teeth and the hall cannot simply churn through suspects; it gives the curser something to play _for_ rather than merely survive, since framing an innocent is now worth two candles; and it is the one part of the adults' clock a five-year-old can read, because she can count candles. A secret errand was rejected as a second hidden system to explain at a party where the first one is already the whole ask.                                                                                                    |
| 11  | **A parent and child are one character, not two guests who happen to be linked.** Four duo characters, each a named pair with an ability neither half has alone: the Godmother and her Godchild (crowns count double, so she reaches the ceiling on half the kneeling), the Huntsman and the Wolf-Cub (one question a night — has this guest ever told a lie), the Nursemaid and the Sleeping Princess (she sees every meeting in the hall, not only her own), the Spinner and the Thread-Holder (a piece dealt to the child reaches the grown-up too).                             | **The pair as bookkeeping** — two ordinary parts with a private link between them, shared clue access and a pooled vote, which is what decisions 2 and 9 had built.                                                                                         | Topher's call, and it turns the duo from a rule into somebody you _are_. It also fixes a quieter problem: the pair's advantages were scattered across the codebase as special cases in `weightOf` and `viewFor`, and naming the character gives them one home and one explanation at the table. Each ability is built from state that already existed — crowns, the lie ledger, the encounter graph, the piece deck — so no new machinery was needed to make four distinct characters. The Godmother is the one to watch: doubling her count _and_ raising her ceiling put her at six voices against a plain guest's one, decisive in a hall of twelve on her own, so the ceiling now barely moves and only the rate does. That number is a guess and wants real players. |
| 12  | **A duo speaks with two voices. Nothing else moves the number.** Vote weight is one for a guest who came alone, two for a duo, and the child's crowns no longer feed into it at all. The Godmother's character is rebuilt on information instead: any falsehood that reaches her own hand shows itself to her.                                                                                                                                                                                                                                                                      | **Crowns as vote weight** (decision 9's coupling, one voice per grown-up who has knelt to your child) and **the Godmother's crowns counting double** on top of it.                                                                                          | Topher's call, and it retires the one number on the branch that measurement could not settle — a well-liked five-year-old's grown-up at six voices against a plain guest's one, decisive alone in a hall of twelve. Two voices flat is a rule anybody can hold in their head at a party, which matters more here than the extra texture did. It costs the neatest version of decision 6's coupling, where the pretend game literally decided the argument; the coupling now runs through information rather than arithmetic, since a child's kneeling still unseals pieces and still feeds the Godmother. Crowns remain the child's scoreboard, which is what they were for.                                                                                              |
